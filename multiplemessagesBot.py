...
phone_numbers = ['919773960061']

options = Options()
options.add_argument("--window-size=1000,800")
# Message to be sent
message = "Link To Cse Section A Unofficial Group - https://chat.whatsapp.com/CV6b6teHpyb4sdXI8ioP0M \n This Message Was Sent To Everyone By A Python Program I Made, Its Open Source On GitHub - \n Quick Q&A \n Am I Dumb To Make A Group Before The Section Is Finalised? \n Nope, I Was Added To The Unofficial CSE B Group And They Got A Lot Of Study Material There, So I Made This So We Are On Par With Them, Your Welcome - Emon"
